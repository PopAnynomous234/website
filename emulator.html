...
<html>
    ...
    <body>
        <div id="top">
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFRjpNYdZCoj9uZzFdEeiWoCEx2kBW-i2Hbw&s" alt="Logo" class="logo">
        </div>
        <div id="box">
        ...
        <script>
            if ("serviceWorker" in navigator) {
                const req = navigator.serviceWorker.register("https://cdn.jsdelivr.net/EmulatorJS/demo/sw.js");
                console.log(req);
            };
            ...
            function loadVersions(response) {
                ...
                version_select.addEventListener("change", () => {
                    ...
                    window.cdn = "https://cdn.jsdelivr.net/gh/genizy/emu@7bf5cbb0b94866568d2aaa1fd42ebb5acd517e0d/";
                });
            }
            input.addEventListener("change", async () => {
                ...
                const cdn = window.cdn || "https://cdn.jsdelivr.net/gh/genizy/emu@7bf5cbb0b94866568d2aaa1fd42ebb5acd517e0d/"
